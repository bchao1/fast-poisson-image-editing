# Seamless cloning
python3 seamless_cloning.py --data_dir data/test1 --gradient_mixing_mode alpha --gradient_mixing_alpha 1.0 --solver bicg
python3 seamless_cloning.py --data_dir data/test2 --solver bicg
python3 seamless_cloning.py --data_dir data/test3 --solver bicg
python3 seamless_cloning.py --data_dir data/test4 --solver bicg
