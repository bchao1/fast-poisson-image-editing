...
# Local color change
time python3 local_color_change.py --data_dir data/color1 --change_hue 60
time python3 local_color_change.py --data_dir data/color1 --change_hue 120
time python3 gray_background.py --data_dir data/color1 
